...
public class Account implements java.io.Serializable {
	...
	public Account(Hotel hotel, Role role) {
		this.hotel = hotel;
		this.role = role;
	}

	public Account(Hotel hotel, Role role, String firstName, String lastName, String email, String password,
			String phone, String image, String active, Boolean status, Set<Bill> bills,
			Set<Complain> complainsForSender, Set<Complain> complainsForHandler) {
		this.hotel = hotel;
		this.role = role;
